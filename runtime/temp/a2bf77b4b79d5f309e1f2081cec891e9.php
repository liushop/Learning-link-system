<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"H:\wangzhanshixun\AppServ\www\learn_link\public/../application/index\view\admin\index.html";i:1532155981;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
				...
				<div class="col-lg-9 col-md-9 w_main_left">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">发布链接</h3>
						</div>

						<div class="panel-body">
							<!--文章列表开始-->
							<form class="from" action="" name="learn_link" method="POST">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="link" id="link" value="http://">
					  </div>

					  <div class="form-group">
					   <button type="submit" class="btn btn-info" onmouseover="validate()" style="float:right;">保存</button>
					  </div>
					</form>
							<!--文章列表结束-->
							<br>
